...
public class DataFromDB {
    ...
    static {
        ...
        mealsList.add(new Meal(LocalDateTime.of(2016, 2, 3, 3, 1), "Test01", 33));
        mealsList.add(new Meal(LocalDateTime.of(2016, 1, 3, 3, 1), "Test02", 313));
        mealsList.add(new Meal(LocalDateTime.of(2016, 3, 3, 3, 1), "Test02", 313));
        mealsList.add(new Meal(LocalDateTime.of(2016, 1, 3, 13, 1), "Test03", 3));
        mealsList.add(new Meal(LocalDateTime.of(2017, 2, 3, 3, 1), "Test04", 3233));
        mealsList.add(new Meal(LocalDateTime.of(2017, 2, 3, 5, 1), "Test04", 33));
        mealsList.add(new Meal(LocalDateTime.of(2017, 2, 3, 3, 21), "Test04", 33));
    ...
    public static List<MealWithExceed> getSortedMealWithExceed() {
        ...
        log.debug("выдаем getSortedMealWithExceed :");
